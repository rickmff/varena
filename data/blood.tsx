export const bloodData = {
  "Brute": [
    ...
    "15% Chance to parry an attack reducing damage taken by 25%. Parrying an attack increases your own physical power by 15% for 3.5s"
  ],
  "Corrupted": [
    ...
    "12% Increased Movement Speed and 14% increased Attack Speed but there is a 25% chance when taking damage to trigger an eruption inflicting a 2s snare",
    "Spell and Weapon Charge Gain increased by 10 but there is a 30% chance to spawn a shadow that attacks you when using an ability"
  ],
  "Mutant": [
  ...
  "Scholar": [
    "12% Increased Spell Power and 10% Shield Efficiency",
    "12% Increased Spell Cooldown Rate and shield self for 25% of your spell power when casting a spell",
    "20% Ultimate Power and reset your Spell Cooldowns when using an Ultimate",
    "12 Increased Spell Charge Gain"
  ],
  "Warrior": [
    "10% Increased Physical Power and Veil attacks deal 40% bonus damage",
    "14% Increased Weapon Cooldown Rate and 5% increased Weapon Skill Leech",
    "18% Increased Weapon Skill power and 24% increased damage when striking enemies at full health",
  ...
  "Draculin": [
    "12% Increased Spell Power and 8% increased Spell Critical Power",
    "16% Increased Spell Critical Chance and Spell hits grants 6% Movement Speed for 3s",
    "8% Increased Spell Leech and 3 increased Spell Charge Gain",
    "Spell Critical Strike Hits increases Spell Cooldown Rate by 30% for 3s"
  ],
  "Creature": [
